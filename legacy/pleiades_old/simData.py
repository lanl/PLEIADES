...
def parse_xs_file(file_location, isotope_name, verbose_level=0):
    ...
    if verbose_level > 0:
        print(f"[parse_xs_file] -> Looking for {isotope_handle}")
...
class Isotope:
    ...
    def __init__(
        ...
        atomic_mass=0.0,
        thickness=0.0,
        thickness_unit="atoms/cm2",
        abundance=0.0,
        xs_file_location="Unknown",
        density=0.0,
        density_unit="g/cm3",
    ):
        self.name = name
...
def write_transmission_data_json(
    ...
    """Write the transmission data to a json file with the following info:
        {
            ...
            "data": {
                "transmission": [t_0,t_1,t_2,t_3,....t_k],
    ...
    data_structure = {
        ...
        "data": {"transmission": transmission_data, "neutronEnergies": energy_data},
    }
