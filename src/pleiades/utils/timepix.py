...
def update_with_nexus_files(
    master_dict: dict, normalization_status: NormalizationStatus, nexus_path: str, facility=Facility.ornl
) -> None:
    """
...
def update_with_nexus_files_at_ornl(
    master_dict: dict, normalization_status: NormalizationStatus, nexus_path: str
) -> None:
...
def update_with_proton_charge(
    master_dict: dict, normalization_status: NormalizationStatus, facility=Facility.ornl
) -> None:
    """
...
def update_with_proton_charge_at_ornl(master_dict: dict, normalization_status: NormalizationStatus) -> None:
    """
...
def update_with_shutter_values_at_ornl(master_dict: dict, normalization_status: NormalizationStatus) -> None:
    """
