...
class ParFile:
    ...
    def write(self, filename: str = "params.par") -> None:
        ...
        if not self.data:
            raise RuntimeError(
                "self.data is emtpy, please run the self.read() method first"
            )
    ...
    def _read_spin_group(self, spin_group_line: str) -> dict:
        ...
        spin_group_dict = {
            key: spin_group_line[value] for key, value in self._SPIN_GROUP_FORMAT.items()
        }
    ...
    def limit_energies_of_parfile(self) -> None:
        ...
        for num, res in enumerate(self.parent.data["resonance_params"]):
            ...
            energy = (
                ...
                .lstrip("e")
                .replace("+", "e+")
                if not "e" in res["reosnance_energy"]
