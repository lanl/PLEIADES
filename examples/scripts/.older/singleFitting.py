...
def main(config_inp_file: str = "config_inp.ini"):
    ...
    sammy_input.data["Card3"]["commands"] = (
        "CHI_SQUARED,CSISRS,SOLVE_BAYES,QUANTUM_NUMBERS,REICH_MOORE_FORM,GENERATE ODF FILE AUTOMATICALLY,RPI TRANSMISSION RESOLUTION FUNCTION"
    )
    ...
    lpt.register_new_stats(
        keyname="weight_153",
        start_text="  Isotopic abundance",
        skipped_rows=3,
    ...
    df = pandas.read_csv(
        "archive/Eu_153/results/Eu_153.lst",
